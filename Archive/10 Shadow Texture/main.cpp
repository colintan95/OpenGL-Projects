...
void glInit() {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, gScreenWidth * 2, gScreenHeight * 2, 0, GL_DEPTH_COMPONENT, GL_FLOAT, NULL);
    ...
    glFramebufferTexture(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, gRenderTexture, 0);
    ...
    glm::vec3 coneDir = {0.1f, -1.f, 0.f};
    glm::vec4 lightPos = {0.f, 30.f, 0.f, 1.f};
    ...
    gTeapotObj.diffuseColor = {0.5f, 0.f, 0.f};
